...
<body>  
			        ...
			        <ul class="nav navbar-nav">
			            ...
			            <li class="dropdown">
			                ...
			                <ul class="dropdown-menu">
			                    <li><a href="getNews.Servlet">所有新闻</a></li>
			                    <li class="divider"></li>
			                    <li><a href="#">热点新闻</a></li>
			                </ul>
			            </li>
			            <li class="dropdown">
			                ...
			                <ul class="dropdown-menu">
			                    <li><a href="getTalks.Servlet">所有话题</a></li>
			                    <li class="divider"></li>
			                    <li><a href="#">热点话题</a></li>
			                </ul>
			            </li>
			        	...
			        	<li>  
				            <form class="navbar-form navbar-left" role="search">
						        <div class="form-group">
						          <input type="text" class="form-control" placeholder="新闻和课程">
						        </div>
	...
	<div style="padding-top:100px">
			<div class="panel panel-success center-block" style="width:60%">
					<div class="panel-heading">
						<h3>收藏的新闻:</h3>
					</div>
					<div class="panel-body">
						<c:forEach items="${News}" var="n">
						<p class="label label-info" style="margin-right:10px;">${n.tags}</p><a href="getNewsComment.Servlet?id=${n.id}&title=${n.title}&url=${n.url}">${n.title}</a>
						<hr>
						</c:forEach>
					</div>
			</div>
			<div class="panel panel-info center-block" style="width:60%">
					<div class="panel-heading">
						<h3>发表的话题：</h3>
					</div>
					<div class="panel-body">
			...
			<div class="panel panel-warning center-block" style="width:60%">
					<div class="panel-heading">
						<h3>收藏的话题：</h3>
					</div>
					<div class="panel-body">
						<c:forEach items="${FavoriteTalk}" var="f">
							<a href="getTalksComment.Servlet?title=${f.title}&text=${f.text}&userID=${f.userID}">${f.title}</a>
							<h5 align="right">发帖人：${f.userID}</h5>
							<hr>
						</c:forEach>
					</div>
			</div>
