...
<body>  
	...
	<div style="padding-top:100px;">
		<div class="panel panel-warning center-block" style="width:50%">
			   <c:forEach items="${Talks}" var="t">
						<div class="panel-heading">
							<h3 class="panel-title"><a href="getTalksComment.Servlet?title=${t.title}&text=${t.text}&userID=${t.userID}">${t.title}</a></h3>
						</div>
