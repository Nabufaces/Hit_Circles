...
<body>  
		...
		<div style="padding-top:100px">
			<div class="panel panel-warning center-block" style="width:70%">
				...
				<div class="panel-body">
						...
						<form method="post" action="setNewsComment.Servlet?id=${id}">
							<h5>回复区 </h5> 
							<hr>
							<textarea name="comment" style="width:50%;height:200px;border:1px solid #f0ad4e;"></textarea>
							<p></p>
							<input type="submit" class="btn btn-primary active"  role="button" style="background-color:#0088cc;" value="提交">
						</form>		
				</div>
			</div>
		</div>
